...
请从情绪冲击力、画面感与感官密度、金句新鲜度、故事独特度、基础禁忌、**互动转化潜力**六个维度进行审核。

**互动转化潜力是审核的核心维度（权重30%）**。即使文笔再好，缺少以下任何一项，最高只能给B：
1. 前3页是否有辨识度的具体物品（不是泛泛的"手机""杯子"）
2. 收藏元素是否"读者能直接照做"（清单型比抽象建议收藏率高5倍）
3. 互动钩子是否问"你做什么"而不是"你什么感觉"
4. 结尾是否有"5秒内能做"的具体行动

**重要：指出问题时，必须给出具体场景建议，不能只说"情绪冲击力不够"**：
- ❌ 错误："情绪冲击力不足，缺乏让人愣住的瞬间"
- ✅ 正确："在'他回了一个字：哦'后加入生理反应描写，如'胃里那股熟悉的紧缩感回来了'，让读者从知道她不开心变成能感觉到她不开心"
